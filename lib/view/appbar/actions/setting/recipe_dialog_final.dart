...
//   List<Config> configs = [];
//   ConfigDAO _OESsetDAO = ConfigDAO();

//   void selectConfigInDialog() async {
//     try {
//       List<OESSet> aaa = await _OESsetDAO.selectConfigDao();
//       configs.clear();
//       configs.addAll(aaa);
//       setState(() {});
//     } catch (err) {
...
//     try {
//       Config aaa = await _OESsetDAO.addNewConfigDao(config);
//       config.id = aaa.id;
//       msg('컨피그 추가 성공');
//       setState(() {});
//     } catch (error) {
...
//     try {
//       if (await _OESsetDAO.modifyOESSetDao(config)) {
//         msg('업데이트 성공');
//         return;
//       }
//       msg('asadd');
...
//     try {
//       if (config.id != null) {
//         if (await _OESsetDAO.deleteConfigDao(config)) {
//           msg('컨피그 삭제 성공');
